...
import { bookmarksSchema } from "./BookmarkModel";
import { postLabelsSchema } from "./PostLabelModel";
...
const {
  storeitemsSchema,
} = require("../../../chatServer/models/StoreItemsModel");
import { userCartSchema } from "./UserCartModel";
const {
  storeItemsOrderSchema,
} = require("../../../chatServer/models/StoreItemsOrderModel");
const {
  userNotesSchema,
} = require("../../../chatServer/models/UserNotesModel");
import UserList, { userListSchema } from "./UserListsModel";
import { pollSchema } from "./PollModel";
...
const schemas = {
  ...
  usercarts: userCartSchema,
  storeitemsorders: storeItemsOrderSchema,
