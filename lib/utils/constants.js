...
export const COLLECTIONS_USER_LISTS_HUB =
  typeof window !== "undefined" && window.innerWidth > MOBILE_SM
    ? "/my/collections/user-lists/subscriptions"
    : "/my/collections/user-lists/userlistshub"; // default route for collections
export const COLLECTIONS_USER_LISTS_ROUTE = "/my/collections/user-lists";
// COLLECTIONS - BOOKMARKS
export const COLLECTIONS_BOOKMARKS_HUB =
  typeof window !== "undefined" && window.innerWidth > MOBILE_SM
    ? "/my/collections/bookmarks/all-bookmarks"
    : "/my/collections/bookmarks/userlistshub"; // default route for bookmarks
export const COLLECTIONS_BOOKMARKS_ROUTE = "/my/collections/bookmarks";
// COLLECTIONS - POST LABELS
export const COLLECTIONS_POST_LABELS_HUB =
  typeof window !== "undefined" && window.innerWidth > MOBILE_SM
    ? "/my/collections/post-labels/all-post-labels"
    : "/my/collections/post-labels/userlistshub"; // default route for post labels
