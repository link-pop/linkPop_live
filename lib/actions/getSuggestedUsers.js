...
export const getSuggestedUsers = async (
  ...
  try {
    ...
    if (mongoUser?.profileType === "fan") {
      ...
      console.log("  preferCountry:", mongoUser.preferCountry);
      ...
      if (userHasPreferences) {
        ...
        for (const creator of creatorsWithTags) {
          ...
          if (mongoUser?.preferCountry || mongoUser?.preferCountryCode) {
            if (
              !doesLocationMatch(
                mongoUser.preferCountry,
              ...
              console.log(
                "  ❌ Location mismatch:",
                mongoUser.preferCountry || mongoUser.preferCountryCode,
                "vs",
                creator.country || creator.countryCode
              );
            } else {
              console.log(
                "  ✅ Location match:",
            ...
            console.log("  ⚪ Location preference not set");
          }
