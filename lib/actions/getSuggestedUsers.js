...
export const getSuggestedUsers = async (
  ...
  try {
    ...
    // Initialize query filters with price filter applied at database level
    let filters = {
      // Only get users with profile images
      profileImage: { $ne: "" },
      // Apply price filter at database level for better performance
      ...createPriceFilter(showPaidOnly),
    };
    ...
    if (mongoUser?.profileType === "fan") {
      ...
      console.log("  raceEthnicity:", mongoUser.raceEthnicity);
        ...
        for (const creator of creatorsWithTags) {
          ...
          if (
            ...
            if (
              ...
              mongoUser.raceEthnicity !== creatorMostFrequentTags.raceEthnicity
            ) {
              isMatch = false;
              console.log(
