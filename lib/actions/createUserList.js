  ...
  try {
    ...
    const newList = await add({
      ...
      data: {
        ...
        active: true,
        sortOrder: 0,
        attachmentIds: [], // Initialize with empty array for attachment collections
        lastAttachmentUrls: [], // Initialize with empty array for preview URLs
        userIds: [], // Initialize with empty array for user collections
        lastUserProfileImages: [], // Initialize with empty array for user preview images
      },
    });
