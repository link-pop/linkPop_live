 ...
 * - User preferences: preferAge, preferRaceEthnicity, preferHairColor, preferBodyType, preferGender
 *
...
export const clearAllSuggestions = async () => {
  try {
    ...
    const result = await update({
      ...
      update: {
        preferAge: null,
        preferRaceEthnicity: null,
        preferHairColor: null,
        preferBodyType: null,
        preferGender: null,
        preferCreatorName: null,
        preferCountry: null,
        preferCountryCode: null,
        hiddenSuggestions: [],
