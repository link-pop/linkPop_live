...
// Gender options
export const GENDER_TAGS = ["female", "male", "non-binary", "transgender"];
...
export const GENDER_OPTIONS = createSelectOptions(GENDER_TAGS, true);
...
export const GENDER_OPTIONS_FAN = createSelectOptions(GENDER_TAGS, true, true);
