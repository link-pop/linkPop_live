...
export async function GET(req) {
  try {
    ...
    const { postId, userId, purchaseId } = session.metadata;
    console.log("Session metadata:", { postId, userId, purchaseId });
    ...
    console.log("Redirecting to:", `${baseUrl}/feeds/${postId}`);

    // Redirect to the post
    return NextResponse.redirect(`${baseUrl}/feeds/${postId}`);
  } catch (error) {
    console.error(
