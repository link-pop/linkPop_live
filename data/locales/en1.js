const en = {
  ...
  greenhair: "Green Hair",
  rainbowhair: "Rainbow Hair",
  // Legacy translations for backward compatibility
  brown: "Brown",
  red: "Red",
  gray: "Gray",
  ...
  // Clear all suggestions functionality
  resetSuggestions: "Reset all suggestions",
  allSuggestionsCleared: "All suggestions cleared",
  allSuggestionsDataReset:
    "Suggestion algorithm has been reset. Refreshing suggestions...",
  errorClearingAllSuggestions: "Failed to clear all suggestions",
  ...
  autoGeneratedTagsInfo:
    "Auto-generated tags are used based on your profile visit history for suggestions. You can change your suggestions by manually setting your preferences below.",
  preferencesProgress: "Visit more creators to get better suggestions",
  visitAtleast: "Visit at least",
  creators: "creators",
  ...
  attachmentsRemovedFromList: "{{count}} attachment(s) removed from list",
